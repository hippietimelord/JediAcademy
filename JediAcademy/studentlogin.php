   ...
   if(isset($_POST['submit']))
	{
	   // Connect to server and select databse.
		...
		$sql="SELECT * FROM $tblname2 WHERE id='$username' and password='$password'";
...
<body>
	...
	<footer>
		...
		<a style="float: right;font-family: 'Fjalla One', sans-serif;color: white;" href="login.php">You can login as Admin&nbsp;&nbsp;</a></p>
	</footer>
</body>
</html>
